...
const props = defineProps({
  ...
  viewportMargin: { type: Number, default: 8 },
  closeOnAction: { type: Boolean, default: true },
  sideOffsetX: { type: Number, default: 0 },
  custom: {type:Boolean, default: false},
  placement: { type: String, default: 'left' },
  anchorEl: { type: Object, default: null }, // HTMLElement o ref
...
watch(
  () => [props.open, props.anchorRect, props.items.length],
  () => updateMenuPosition()
)
...
.menu-pop-leave-to {
  ...
  transform-origin: top left; /* puoi cambiarlo a top right se preferisci */
}
